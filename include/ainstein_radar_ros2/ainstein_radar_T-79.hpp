...
{
public:
  AinsteinRadarDriverT79(
    bool sendRaw, bool sendTracked, int canId, std::string frameId,
  ...
  void processRadarStop(
    const rclcpp::Publisher<radar_msgs::msg::RadarScan>::SharedPtr & publisher_raw,
    const rclcpp::Publisher<radar_msgs::msg::RadarScan>::SharedPtr & publisher_tracked,
    const rclcpp::Logger & logger) override;
  radar_msgs::msg::RadarReturn::UniquePtr processRadarOutput(
    const can_msgs::msg::Frame::SharedPtr & msg) override;
